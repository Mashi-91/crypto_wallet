...
class SpecificScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final trailingAmount = Args['amount'] as double;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              MoneyFormatter(amount: trailingAmount).output.symbolOnLeft,
              style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                  fontSize: 32),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              ...providerTransaction.button.map((e) {
                                return Column(
                                  children: [
                                    GestureDetector(
                                      onTap: (){},
                                    ...
                                    Text(e.title, style: TextStyle(fontWeight: FontWeight.w500,fontSize: 15),)
                                  ],
                                );
                              }).toList()
                            ],
                                ...
                                return Column(
                                  children: [
                                    cardwithtransaction(
                                        ...
                                        title:
                                        providerTransaction.transData[i].title,
